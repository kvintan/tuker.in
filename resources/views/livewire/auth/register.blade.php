            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex flex-col gap-5 items-center justify-center">
                        <button type="submit"
                            class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium font-inter rounded-3xl px-5 py-2.5 text-center bg-[#37654E] w-1/4 h-15 text-xl">Sign
                            up</button>
                        <p class="text-sm text-black">
                            Already have an account? <a href="/login"
                                class="font-bold text-primary-600 hover:underline text-[#37654E]">Login here</a>
                        </p>
                    </div>
                </form>
            </div>
