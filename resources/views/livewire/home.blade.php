    <div>
        ...
        <div class="md:w-1/2 flex justify-center">
            <div class="">
                <img src="{{ asset('images/home.png') }}" alt="Trash Bin"
                    class="w-full h-[83vh] object-cover ml-[40vw] mt-[-50vh]">
            </div>
        ...
        <div class="flex flex-col items-center justify-center px-6 py-16 max-w-7xl mx-auto text-center gap-6">
            ...
            <p class="font-inter text-xl max-w-3xl">
                We provide smart and eco-friendly waste collection solutions, making it easier for individuals and
                businesses to manage and recycle waste effectively
            </p>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 w-full h-80">
                <!-- card 1 -->
                <div
                    class="flex flex-col items-center bg-[#376551] rounded-2xl p-8 h-full shadow-md hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-white font-inter font-light">
                        Easily schedule waste pickups for recycling, making it convenient to dispose of and repurpose
                        your
                ...
                <div
                    ...
                    <p class="text-white font-inter font-light">
                        Browse and purchase eco-friendly products made from recycled materials, supporting sustainable
                ...
                <div
                    ...
                    <p class="text-white font-inter font-light">
                        Participate in exciting auctions for recycled goods and waste management services, contributing
                        to a
                        circular economy.
                    </p>
                </div>
        ...
        <div class="flex flex-col items-center justify-center px-6 py-16 max-w-7xl mx-auto text-center gap-6">
            ...
            <div class="grid grid-cols-3 gap-6 mt-4">
                ...
                <div class="flex flex-col items-center gap-2">
                    <div
                        class="bg-[#A7DE89] w-72 h-72 rounded-xl border-black border-[0.2vw] flex items-center justify-center">
                ...
                <div class="flex flex-col items-center gap-2">
                    <div
                        class="bg-[#A7DE89] w-72 h-72 rounded-xl border-[0.2vw] border-black flex items-center justify-center">
            ...
            <a href="#" class="mt-8">
                <div
                    class="bg-[#37654E] hover:bg-[#2b4a3a] text-[2vw] w-[20vw] text-white font-semibold font-inter px-8 py-3 rounded-full transition duration-300">
                    See Auction
                </div>
            </a>
        </div>
        ...
        <div class="flex flex-col items-center justify-center px-6 py-16 max-w-7xl mx-auto text-center gap-6">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-8 mt-8 w-full">
                <div
                    class="bg-[#37654E] rounded-[7vw] p-6 shadow-md w-full h-[60vh] flex flex-col md:flex-row items-center gap-6">
                    <img src="{{ asset('images/chelsea.png') }}" alt="Chelsea Leawana"
                        class="w-48 h-48 ml-[10vw] rounded-full object-cover" />
                    <div class="text-center md:text-left w-[43vw]">
                        <h1 class="font-inter font-bold text-[4vw] text-white">Celsi Leawana</h1>
                        <p class="text-white font-inter text-lg mt-2">
                            Using TUKER.IN has been a game-changer for me! It's an innovative platform that not only
                            helps
                            me recycle efficiently but also allows me to earn from my waste, making a positive impact on
                            both the environment and my wallet.
                        </p>
