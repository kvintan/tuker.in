<div>
    ...
    <div class="max-w-5xl mx-auto space-y-6 font-inter">
        ...
        <div class="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center mt-10 gap-6 font-inter">
            <a href="/product"
                class="bg-[#4CAF50] hover:bg-[#43A047] text-white font-bold px-6 py-3 rounded-xl flex items-center">
                ← Continue Shopping
            </a>
            ...
            <div class="text-center w-1/3">
                ...
                <a href="/checkout" wire:navigate>
                    <button class="bg-[#4CAF50] hover:bg-[#43A047] text-white font-bold px-6 py-3 rounded-xl mt-4">
                        Checkout
                    </button>
                </a>
            </div>
