                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        ...
                        <input type="name" name="name" id="name"
                            class="bg-[#EFF5EB] border border-black text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            placeholder="enter your name" required>
                    </div>
                    <div>
                        <label for="phoneNumber" class="block mb-2 font-semibold font-inter text-xl">Phone
                            Number</label>
                    ...
                    <div class="flex flex-col gap-5 items-center justify-center py-10">
                        ...
                        <button type="submit"
                            class="text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium font-inter rounded-lg px-5 py-2.5 text-center bg-[#37654E] w-1/4 h-15 text-xl">Sign
                            up</button>
                    </div>
                </form>
            </div>
