        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 w-full h-80">
            ...
            <div
                ...
                <p class="text-white font-inter font-light">
                    Easily schedule waste pickups for recycling, making it convenient to dispose of and repurpose your
            ...
            <div
                ...
                <p class="text-white font-inter font-light">
                    Participate in exciting auctions for recycled goods and waste management services, contributing to a
                    circular economy.
                </p>
            </div>
        </div>
            ...
            <div
                ...
                <div class="text-center md:text-left w-[43vw]">
                    ...
                    <p class="text-white font-inter text-lg mt-2">
                        Using TUKER.IN has been a game-changer for me! It's an innovative platform that not only helps
